...
class SnowflakeRemoteStorageUtil(object):
    ...
    def create_client(stage_info, use_accelerate_endpoint=False):
        util_class = SnowflakeRemoteStorageUtil.getStorageType(stage_info[u'locationType'])
        return util_class.create_client(stage_info, use_accelerate_endpoint=False)
    ...
    def upload_one_file_to_s3(meta):
        ...
        file_header = util_class.get_file_header(meta, meta[u'dst_file_name'])
        ...
        for retry in range(max_retry):
            ...
            elif(meta[u'result_status'] == ResultStatus.NEED_RETRY_WITH_LOWER_CONCURRENCY):
                last_err = meta[u'last_error']
            ...
            if(meta[u'result_status'] == ResultStatus.DOWNLOADED):
                if u'encryption_material' in meta:
                    ...
                    tmp_dst_file_name = SnowflakeEncryptionUtil.decrypt_file(
                        file_header.encryption_metadata, meta[u'encryption_material'],
