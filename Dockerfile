...
# The below RUN instruction is what makes previously failing reproduction-code to work again
...
RUN cmd /S /C "pip install pyarrow==1.19.0.0 snowflake-connector-python==3.12.4
