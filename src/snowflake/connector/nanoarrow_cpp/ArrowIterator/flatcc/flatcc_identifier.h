 ...
 */
static inline flatbuffers_thash_t flatbuffers_type_hash_from_name(
    const char *name) {
 ...
 */
static inline void flatbuffers_identifier_from_type_hash(
    flatbuffers_thash_t type_hash, flatbuffers_fid_t out_identifier) {
...
static inline flatbuffers_thash_t flatbuffers_type_hash_from_identifier(
  ...
  return identifier ? (uint32_t)p[0] + (((uint32_t)p[1]) << 8) +
 ...
 */
static inline flatbuffers_thash_t flatbuffers_type_hash_from_string(
 ...
 */
static inline void flatbuffers_identifier_from_name(
    const char *name, flatbuffers_fid_t out_identifier) {
  flatbuffers_identifier_from_type_hash(flatbuffers_type_hash_from_name(name),
                                        out_identifier);
}
 ...
 */
static inline uint32_t flatbuffers_disperse_type_hash(
...
static_assert(sizeof(flatbuffers_fid_t) == 4,
              "unexpected file identifier size");
