...
DEFAULT_CONFIGURATION: dict[str, tuple[Any, type | tuple[type, ...]]] = {
    ...
    "stored_proc_mode": (True, (type(None), bool)),
...
class SnowflakeConnection:
            ...
            if self._session_token and self._master_token:
                ...
                if self.auth_class is not None:
                    if type(
                        ...
                        raise TypeError(
                            "auth_class must be a child class of AuthByKeyPair"
                        )
    ...
    def cmd_query(
        ...
        ret = self.rest.request(
            ...
            _no_retry=_no_retry or self._stored_proc_mode,
            timeout=timeout,
        )
