...
class SnowflakeFileTransferAgent:
    ...
    def __init__(
        ...
        command: str,
        ret: dict[str, Any],
        put_callback: SnowflakeProgressPercentage | None = None,
        put_azure_callback: SnowflakeProgressPercentage | None = None,
        put_callback_output_stream: IO[str] = sys.stdout,
        get_callback: SnowflakeProgressPercentage | None = None,
        get_azure_callback: SnowflakeProgressPercentage | None = None,
