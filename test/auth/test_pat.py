...
def get_pat_token():
    okta_connection_parameters = AuthConnectionParameters().get_okta_connection_parameters()
    ...
    token = test_helper.connect_using_okta_connection_and_execute_custom_command(command, True)
    return token
