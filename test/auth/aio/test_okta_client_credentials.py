...
@pytest.mark.auth
@pytest.mark.asyncio
async def test_okta_client_credentials_successful():
...
@pytest.mark.auth
@pytest.mark.asyncio
async def test_okta_client_credentials_mismatched_user():
    connection_parameters = (
        AuthConnectionParameters().get_oauth_external_client_credential_connection_parameters()
    )
...
@pytest.mark.auth
@pytest.mark.asyncio
async def test_okta_client_credentials_unauthorized():
    connection_parameters = (
        AuthConnectionParameters().get_oauth_external_client_credential_connection_parameters()
    )
