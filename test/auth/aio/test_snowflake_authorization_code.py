...
@pytest.mark.auth
@pytest.mark.asyncio
async def test_snowflake_authorization_code_successful():
...
@pytest.mark.auth
@pytest.mark.asyncio
async def test_snowflake_authorization_code_mismatched_user():
    connection_parameters = (
        AuthConnectionParameters().get_snowflake_authorization_code_connection_parameters()
    )
...
@pytest.mark.auth
@pytest.mark.asyncio
async def test_snowflake_authorization_code_timeout():
    connection_parameters = (
        AuthConnectionParameters().get_snowflake_authorization_code_connection_parameters()
    )
    test_helper = AuthorizationTestHelper(connection_parameters)
...
@pytest.mark.auth
@pytest.mark.asyncio
async def test_snowflake_authorization_code_without_token_cache():
    connection_parameters = (
        AuthConnectionParameters().get_snowflake_authorization_code_connection_parameters()
    )
