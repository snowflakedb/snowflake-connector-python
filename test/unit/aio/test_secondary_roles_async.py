#!/usr/bin/env python
"""Async tests for the secondary_roles connection parameter."""
...
def _init_rest_with_secondary_roles(application, secondary_roles, post_request):
    """Initialize an async REST client with secondary_roles configured."""
...
def _create_mock_auth_success_response():
    """Create a mock async auth response that captures the request body."""
    captured_body = {}
...
class TestSecondaryRolesParameterAsync:
    """Async tests for secondary_roles connection parameter."""
