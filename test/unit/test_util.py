...
try:
    from snowflake.connector._utils import _CoreLoader, _TrackedQueryCancellationTimer
except ImportError:
    pass
    ...
    def test_get_core_path_windows(self):
        ...
        with mock.patch.object(sys, "platform", "win32"):
            with mock.patch("importlib.resources.files") as mock_files:
                ...
                mock_files_obj.joinpath.assert_called_once_with("libsf_mini_core.dll")
    ...
    def test_get_core_path_linux(self):
        ...
        with mock.patch.object(sys, "platform", "linux"):
            with mock.patch("importlib.resources.files") as mock_files:
                ...
                mock_files.assert_called_once_with("snowflake.connector.minicore")
                mock_files_obj.joinpath.assert_called_once_with("libsf_mini_core.so")
