...
@pytest.mark.parametrize(
    "key_aad, data_aad",
    [("", ""), (base64.b64encode(b"test key aad"), base64.b64encode(b"test data aad"))],
)
def test_gcm_encrypt_decrypt_file(tmp_path, key_aad, data_aad):
    """Encrypts and Decrypts a file."""
    encryption_material = SnowflakeFileEncryptionMaterial(
        query_stage_master_key="ztke8tIdVt1zmlQIZm0BMA==",
        query_id="123873c7-3a66-40c4-ab89-e3722fbccce1",
    ...
    try:
        ...
        (metadata, encrypted_file) = SnowflakeEncryptionUtil.encrypt_file_gcm(
            encryption_material,
            input_file,
        ...
        assert key_aad == metadata.key_aad and data_aad == metadata.data_aad
        decrypted_file = SnowflakeEncryptionUtil.decrypt_file_gcm(
            metadata, encryption_material, encrypted_file, tmp_dir=str(tmp_path)
        )
...
def test_gcm_encrypt_decrypt_large_file(tmpdir, key_aad, data_aad):
    """Encrypts and Decrypts a large file."""
    encryption_material = SnowflakeFileEncryptionMaterial(
        query_stage_master_key="ztke8tIdVt1zmlQIZm0BMA==",
        query_id="123873c7-3a66-40c4-ab89-e3722fbccce1",
