...
- v3.4.0(TBD)
  ...
  - Fixed `login_timeout` and `network_timeout` (renamed to `request_timeout` for clarity) behaviour. Retries of login and network requests are now properly halted after these timeouts expire.
