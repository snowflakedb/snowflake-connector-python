...
- v3.18.0(TBD)
  ...
  - Fixed behaviour of trying S3 Transfer Accelerate endpoint by default, and always getting HTTP403 due to permissions missing on purpose. Now /accelerate is not attempted.
