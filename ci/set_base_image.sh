...
if [[ -n "$JENKINS_HOME" ]]; then
    ...
    export BASE_IMAGE_MANYLINUX2014=$INTERNAL_REPO/docker/manylinux2014_x86_64:2026.03.14-2
    export BASE_IMAGE_MANYLINUX2014AARCH64=$INTERNAL_REPO/docker/manylinux2014_aarch64:2026.03.14-2
