...
# NOTES:
#   - By default this script runs Python 3.10 tests, as these are installed in dev vms
#   - To compile only a specific version(s) pass in versions like: `./test_docker.sh "3.10 3.11"`
