...
/opt/python/cp312-cp312/bin/python -m pip install --break-system-packages uv

# setup pytest
/opt/python/cp312-cp312/bin/python -m uv pip install --break-system-packages pytest pytest-asyncio

# # test WIF without asyncio installed
# /opt/python/cp312-cp312/bin/python -m uv pip install --break-system-packages -e .
# /opt/python/cp312-cp312/bin/python -m pytest test/wif/ --ignore test/wif/test_wif_async.py

# test WIF with asyncio installed
/opt/python/cp312-cp312/bin/python -m uv pip install --break-system-packages -e '.[aio]'
