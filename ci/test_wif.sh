...
run_tests_on_aks "$SNOWFLAKE_TEST_WIF_AKS_CLUSTER_1" "$SNOWFLAKE_TEST_WIF_AKS_SA_MI" "$SNOWFLAKE_TEST_WIF_HOST_AKS" "$SNOWFLAKE_TEST_WIF_USERNAME_AKS" "AKS MI cluster 1" "test_aks_workload_identity_auth"
run_tests_on_aks "$SNOWFLAKE_TEST_WIF_AKS_CLUSTER_1" "$SNOWFLAKE_TEST_WIF_AKS_SA_SP" "$SNOWFLAKE_TEST_WIF_HOST_AKS" "$SNOWFLAKE_TEST_WIF_USERNAME_AKS_SP" "AKS SP cluster 1" "test_aks_workload_identity_auth"
...
run_tests_on_aks "$SNOWFLAKE_TEST_WIF_AKS_CLUSTER_2" "$SNOWFLAKE_TEST_WIF_AKS_SA_MI" "$SNOWFLAKE_TEST_WIF_HOST_AKS" "$SNOWFLAKE_TEST_WIF_USERNAME_AKS" "AKS MI cluster 2" "test_aks_workload_identity_auth"
